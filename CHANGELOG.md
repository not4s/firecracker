...
- [#XXXX](https://github.com/firecracker-microvm/firecracker/pull/XXXX): Fixed the
  vsock device stalling the VMM thread when the guest connects to a host-side
  Unix socket whose accept backlog is full. Such connection requests are now
  refused instead.
