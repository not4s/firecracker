...
# Pinned so checker updates are deliberate; this build includes Neoverse-V3 support
# https://github.com/speed47/spectre-meltdown-checker/pull/583
CHECKER_URL = "https://raw.githubusercontent.com/speed47/spectre-meltdown-checker/03cc4ffeb1dca9bb8d89f8096dc45015530d3214/spectre-meltdown-checker.sh"
CHECKER_FILENAME = "spectre-meltdown-checker.sh"
REMOTE_CHECKER_PATH = f"/tmp/{CHECKER_FILENAME}"
# json-terse is the old bare-array format; --no-intel-db no longer exists upstream
